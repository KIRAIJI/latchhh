...
class LegalController extends Controller
{
    public function privacy()
    {
        return view('legal', [
            ...
            'sections' => [
                'Information we process' => 'We process account identity and authentication data, including a linked Google/Firebase identity when you choose Google sign-in, optional profile photos, claimed tracker identifiers, precise tracker locations, nearby Wi-Fi access-point identifiers and signal strengths used only when location assistance is needed, geofences, telemetry, notifications, device push tokens, activity records, and security diagnostics required to operate LATCH.',
