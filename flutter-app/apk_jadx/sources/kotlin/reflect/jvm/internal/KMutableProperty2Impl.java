...
public final class KMutableProperty2Impl<D, E, V> extends KProperty2Impl<D, E, V> implements KMutableProperty2<D, E, V> {
    ...
    public KMutableProperty2Impl(KDeclarationContainerImpl container, String name, String signature) {
        ...
        ReflectProperties.LazyVal<Setter<D, E, V>> lazyValLazy = ReflectProperties.lazy(new Function0<Setter<D, E, V>>() { // from class: kotlin.reflect.jvm.internal.KMutableProperty2Impl$_setter$1
            {
                super(0);
            }
        ...
        Intrinsics.checkNotNullExpressionValue(lazyValLazy, "ReflectProperties.lazy { Setter(this) }");
