...
public final class AnnotationQualifiersFqNamesKt {
    ...
    static {
        ...
        Map<FqName, JavaDefaultQualifiers> mapMapOf = MapsKt.mapOf(TuplesKt.to(JvmAnnotationNamesKt.getJSPECIFY_DEFAULT_NOT_NULL(), new JavaDefaultQualifiers(new NullabilityQualifierWithMigrationStatus(NullabilityQualifier.NOT_NULL, false, 2, null), listListOf, false)));
