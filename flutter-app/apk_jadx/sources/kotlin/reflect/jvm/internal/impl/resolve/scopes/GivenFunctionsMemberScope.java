...
public abstract class GivenFunctionsMemberScope extends MemberScopeImpl {
    ...
    public final List<DeclarationDescriptor> createFakeOverrides(List<? extends FunctionDescriptor> list) {
        ...
        Collection<KotlinType> collectionMo1678getSupertypes = this.containingClass.getTypeConstructor().mo1678getSupertypes();
        Intrinsics.checkNotNullExpressionValue(collectionMo1678getSupertypes, "containingClass.typeConstructor.supertypes");
