...
public final class JvmBuiltInsSignatures {
    ...
    static {
        ...
        Set setPlus = SetsKt.plus((Set) setBuildPrimitiveStringConstructorsSet, (Iterable) signatureBuildingComponents4.inJavaLang("Float", strArr));
        ...
        HIDDEN_CONSTRUCTOR_SIGNATURES = SetsKt.plus(setPlus, (Iterable) signatureBuildingComponents4.inJavaLang("String", strArr2));
    ...
    private final Set<String> buildPrimitiveStringConstructorsSet() {
        ...
        while (it.hasNext()) {
            ...
            String[] strArr = new String[strArrConstructors.length];
            System.arraycopy(strArrConstructors, 0, strArr, 0, strArrConstructors.length);
            CollectionsKt.addAll(linkedHashSet, signatureBuildingComponents.inJavaLang(strAsString, strArr));
        }
        return linkedHashSet;
    }
}
