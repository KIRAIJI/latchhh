...
public final class JvmBuiltInsCustomizer implements AdditionalClassPartsProvider, PlatformDependentDeclarationFilter {
    ...
    private enum JDKMemberStatus {
        ...
        public static JDKMemberStatus[] valuesCustom() {
            JDKMemberStatus[] jDKMemberStatusArrValuesCustom = values();
            JDKMemberStatus[] jDKMemberStatusArr = new JDKMemberStatus[jDKMemberStatusArrValuesCustom.length];
            System.arraycopy(jDKMemberStatusArrValuesCustom, 0, jDKMemberStatusArr, 0, jDKMemberStatusArrValuesCustom.length);
        ...
        for (SimpleFunctionDescriptor simpleFunctionDescriptor : additionalFunctions) {
            ...
            if (i == 1) {
                if (!ModalityUtilsKt.isFinalClass(classDescriptor)) {
                    ...
                    simpleFunctionDescriptor2 = (SimpleFunctionDescriptor) copyBuilderNewCopyBuilder.build();
    ...
    public Set<Name> getFunctionsNames(ClassDescriptor classDescriptor) {
        ...
        return functionNames == null ? SetsKt.emptySet() : functionNames;
    }
    ...
    */
    ...
    private final boolean isMutabilityViolation(SimpleFunctionDescriptor simpleFunctionDescriptor, boolean z) {
        ...
        Boolean boolIfAny = DFS.ifAny(CollectionsKt.listOf(simpleFunctionDescriptor), new DFS.Neighbors<CallableMemberDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.jvm.JvmBuiltInsCustomizer.isMutabilityViolation.1
    ...
    private final JDKMemberStatus getJdkMethodStatus(FunctionDescriptor functionDescriptor) {
        ...
        Object objDfs = DFS.dfs(CollectionsKt.listOf(classDescriptor), new DFS.Neighbors<ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.jvm.JvmBuiltInsCustomizer.getJdkMethodStatus.1
            @Override // kotlin.reflect.jvm.internal.impl.utils.DFS.Neighbors
            public final Iterable<ClassDescriptor> getNeighbors(ClassDescriptor classDescriptor2) {
                ...
                while (it.hasNext()) {
                    ClassifierDescriptor classifierDescriptorMo1677getDeclarationDescriptor = ((KotlinType) it.next()).getConstructor().mo1677getDeclarationDescriptor();
                    ClassifierDescriptor original = classifierDescriptorMo1677getDeclarationDescriptor == null ? null : classifierDescriptorMo1677getDeclarationDescriptor.getOriginal();
    ...
    private final boolean isTrivialCopyConstructorFor(ConstructorDescriptor constructorDescriptor, ClassDescriptor classDescriptor) {
        if (constructorDescriptor.getValueParameters().size() == 1) {
            ...
            ClassifierDescriptor classifierDescriptorMo1677getDeclarationDescriptor = ((ValueParameterDescriptor) CollectionsKt.single((List) valueParameters)).getType().getConstructor().mo1677getDeclarationDescriptor();
            if (Intrinsics.areEqual(classifierDescriptorMo1677getDeclarationDescriptor == null ? null : DescriptorUtilsKt.getFqNameUnsafe(classifierDescriptorMo1677getDeclarationDescriptor), DescriptorUtilsKt.getFqNameUnsafe(classDescriptor))) {
                return true;
            }
        }
        return false;
