...
public class OverridingUtil {
    ...
    */
    ...
    public OverrideCompatibilityInfo isOverridableByWithoutExternalConditions(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2, boolean z) {
        ...
        Pair<NewKotlinTypeCheckerImpl, ClassicTypeCheckerContext> pairCreateTypeChecker = createTypeChecker(typeParameters, typeParameters2);
        ...
        if (z) {
            ...
            if (returnType != null && returnType2 != null) {
                ...
                if (i == 0 && !pairCreateTypeChecker.getFirst().isSubtypeOf(pairCreateTypeChecker.getSecond(), returnType2.unwrap(), returnType.unwrap())) {
    ...
    private OverridingUtilTypeCheckerContext createTypeCheckerContext(List<TypeParameterDescriptor> list, List<TypeParameterDescriptor> list2) {
        ...
        return new OverridingUtilTypeCheckerContext(map);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private boolean areTypeParametersEquivalent(kotlin.reflect.jvm.internal.impl.descriptors.TypeParameterDescriptor r5, kotlin.reflect.jvm.internal.impl.descriptors.TypeParameterDescriptor r6, kotlin.Pair<kotlin.reflect.jvm.internal.impl.types.checker.NewKotlinTypeCheckerImpl, kotlin.reflect.jvm.internal.impl.types.checker.ClassicTypeCheckerContext> r7) {
        /*
            r4 = this;
            if (r5 != 0) goto L7
            r0 = 47
    ...
    public static boolean isMoreSpecific(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2) {
        ...
        Pair<NewKotlinTypeCheckerImpl, ClassicTypeCheckerContext> pairCreateTypeChecker = DEFAULT.createTypeChecker(callableDescriptor.getTypeParameters(), callableDescriptor2.getTypeParameters());
        ...
        if (callableDescriptor instanceof PropertyDescriptor) {
            ...
            if (propertyDescriptor.isVar() && propertyDescriptor2.isVar()) {
                return pairCreateTypeChecker.getFirst().equalTypes(pairCreateTypeChecker.getSecond(), returnType.unwrap(), returnType2.unwrap());
            }
