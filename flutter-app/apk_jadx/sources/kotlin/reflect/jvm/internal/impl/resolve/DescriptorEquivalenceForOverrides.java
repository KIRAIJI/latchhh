        ...
        if (!DescriptorUtils.isLocal(callableDescriptor)) {
            ...
            OverridingUtil overridingUtilCreate = OverridingUtil.create(kotlinTypeRefiner, new KotlinTypeChecker.TypeConstructorEquality() { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$areCallableDescriptorsEquivalent$overridingUtil$1
                ...
                public final boolean equals(TypeConstructor c1, TypeConstructor c2) {
                    ...
                    ClassifierDescriptor classifierDescriptorMo1677getDeclarationDescriptor = c1.mo1677getDeclarationDescriptor();
                    ClassifierDescriptor classifierDescriptorMo1677getDeclarationDescriptor2 = c2.mo1677getDeclarationDescriptor();
                    if (!(classifierDescriptorMo1677getDeclarationDescriptor instanceof TypeParameterDescriptor) || !(classifierDescriptorMo1677getDeclarationDescriptor2 instanceof TypeParameterDescriptor)) {
                        return false;
                    }
                    boolean z4 = z;
                    final CallableDescriptor callableDescriptor3 = a;
                    final CallableDescriptor callableDescriptor4 = b;
                    return this.this$0.areTypeParametersEquivalent((TypeParameterDescriptor) classifierDescriptorMo1677getDeclarationDescriptor, (TypeParameterDescriptor) classifierDescriptorMo1677getDeclarationDescriptor2, z4, new Function2<DeclarationDescriptor, DeclarationDescriptor, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$areCallableDescriptorsEquivalent$overridingUtil$1.1
