        ...
        while (i < length) {
            ...
            if ((field.getModifiers() & 8) == 0) {
                ...
                if (observableProperty != null) {
                    ...
                    field.set(descriptorRendererOptionsImpl, descriptorRendererOptionsImpl.property(observableProperty.getValue(this, new PropertyReference1Impl(orCreateKotlinClass, name2, Intrinsics.stringPlus("get", StringsKt.capitalize(name3))))));
                }
            }
        }
