...
public abstract class AbstractBinaryClassAnnotationAndConstantLoader<A, C> implements AnnotationAndConstantLoader<A, C> {
    ...
    private enum PropertyRelatedElement {
        ...
        public static PropertyRelatedElement[] valuesCustom() {
            PropertyRelatedElement[] propertyRelatedElementArrValuesCustom = values();
            PropertyRelatedElement[] propertyRelatedElementArr = new PropertyRelatedElement[propertyRelatedElementArrValuesCustom.length];
            System.arraycopy(propertyRelatedElementArrValuesCustom, 0, propertyRelatedElementArr, 0, propertyRelatedElementArrValuesCustom.length);
    ...
    public final Storage<A, C> loadAnnotationsAndInitializers(KotlinJvmBinaryClass kotlinJvmBinaryClass) {
        ...
        kotlinJvmBinaryClass.visitMembers(new KotlinJvmBinaryClass.MemberVisitor(this) { // from class: kotlin.reflect.jvm.internal.impl.load.kotlin.AbstractBinaryClassAnnotationAndConstantLoader.loadAnnotationsAndInitializers.1
            ...
            public final class AnnotationVisitorForMethod extends MemberAnnotationVisitor implements KotlinJvmBinaryClass.MethodAnnotationVisitor {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public AnnotationVisitorForMethod(AnonymousClass1 this$0, MemberSignature signature) {
            ...
            public class MemberAnnotationVisitor implements KotlinJvmBinaryClass.AnnotationVisitor {
                ...
                public MemberAnnotationVisitor(AnonymousClass1 this$0, MemberSignature signature) {
                    Intrinsics.checkNotNullParameter(this$0, "this$0");
                    Intrinsics.checkNotNullParameter(signature, "signature");
                    this.this$0 = this$0;
