...
public final class JvmAnnotationNames {
    ...
    static {
        ...
        TARGET_ANNOTATION = new FqName(Target.class.getCanonicalName());
        RETENTION_ANNOTATION = new FqName(Retention.class.getCanonicalName());
        DEPRECATED_ANNOTATION = new FqName(Deprecated.class.getCanonicalName());
        DOCUMENTED_ANNOTATION = new FqName(Documented.class.getCanonicalName());
