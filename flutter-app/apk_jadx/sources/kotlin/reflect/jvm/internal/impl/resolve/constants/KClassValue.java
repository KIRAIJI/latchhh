...
public final class KClassValue extends ConstantValue<Value> {
    ...
    public final KotlinType getArgumentType(ModuleDescriptor module) {
        ...
        for (int i = 0; i < iComponent2; i++) {
            ...
            Intrinsics.checkNotNullExpressionValue(kotlinTypeReplaceArgumentsWithStarProjections, "module.builtIns.getArrayType(Variance.INVARIANT, type)");
        }
    ...
    public static final class Companion {
        ...
        public final ConstantValue<?> create(KotlinType argumentType) {
            ...
            if (classifierDescriptorMo1677getDeclarationDescriptor instanceof ClassDescriptor) {
                ClassId classId = DescriptorUtilsKt.getClassId(classifierDescriptorMo1677getDeclarationDescriptor);
