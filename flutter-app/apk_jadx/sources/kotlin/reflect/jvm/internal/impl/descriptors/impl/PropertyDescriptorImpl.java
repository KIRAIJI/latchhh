...
public class PropertyDescriptorImpl extends VariableDescriptorWithInitializerImpl implements PropertyDescriptor {
    ...
    */
    ...
    protected PropertyDescriptor doSubstitute(CopyConfiguration copyConfiguration) {
        ...
        KotlinType kotlinTypeSubstitute = typeSubstitutorSubstituteTypeParameters.substitute(copyConfiguration.returnType, Variance.OUT_VARIANCE);
        ...
        if (receiverParameterDescriptor2 != null) {
            ...
            receiverParameterDescriptorImpl = new ReceiverParameterDescriptorImpl(propertyDescriptorImplCreateSubstitutedCopy, new ExtensionReceiver(propertyDescriptorImplCreateSubstitutedCopy, kotlinTypeSubstitute2, this.extensionReceiverParameter.getValue()), this.extensionReceiverParameter.getAnnotations());
        } else {
