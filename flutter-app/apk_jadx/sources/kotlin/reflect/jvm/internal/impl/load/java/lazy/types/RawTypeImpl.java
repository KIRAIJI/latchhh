...
public final class RawTypeImpl extends FlexibleType implements RawType {
    ...
    public MemberScope getMemberScope() {
        ClassifierDescriptor classifierDescriptorMo1677getDeclarationDescriptor = getConstructor().mo1677getDeclarationDescriptor();
        ...
        if (classDescriptor == null) {
            throw new IllegalStateException(Intrinsics.stringPlus("Incorrect classifier: ", getConstructor().mo1677getDeclarationDescriptor()).toString());
        }
