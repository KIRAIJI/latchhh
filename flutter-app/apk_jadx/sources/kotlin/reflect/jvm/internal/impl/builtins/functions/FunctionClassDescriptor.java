...
public final class FunctionClassDescriptor extends AbstractClassDescriptor {
    ...
    public /* bridge */ /* synthetic */ ClassDescriptor mo1668getCompanionObjectDescriptor() {
    ...
    public /* bridge */ /* synthetic */ ClassConstructorDescriptor mo1669getUnsubstitutedPrimaryConstructor() {
    ...
    private final class FunctionTypeConstructor extends AbstractClassTypeConstructor {
        ...
        protected Collection<KotlinType> computeSupertypes() {
            ...
            if (i == 1) {
                ...
                listListOf = CollectionsKt.listOf((Object[]) new ClassId[]{FunctionClassDescriptor.kFunctionClassId, new ClassId(StandardNames.BUILT_INS_PACKAGE_FQ_NAME, FunctionClassKind.Function.numberedClassName(this.this$0.getArity()))});
            } else if (i == 3) {
                listListOf = CollectionsKt.listOf(FunctionClassDescriptor.functionClassId);
            } else {
                if (i != 4) {
                ...
                listListOf = CollectionsKt.listOf((Object[]) new ClassId[]{FunctionClassDescriptor.kFunctionClassId, new ClassId(StandardNames.COROUTINES_PACKAGE_FQ_NAME_RELEASE, FunctionClassKind.SuspendFunction.numberedClassName(this.this$0.getArity()))});
            }
        ...
        public FunctionClassDescriptor mo1677getDeclarationDescriptor() {
            return this.this$0;
        }

        public String toString() {
            return mo1677getDeclarationDescriptor().toString();
        }
