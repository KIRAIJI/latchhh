...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
            ...
            public final DescriptorRendererImpl invoke() {
                return (DescriptorRendererImpl) this.this$0.withOptions(new Function1<DescriptorRendererOptions, Unit>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$functionTypeAnnotationsRenderer$2.1
                    ...
                    public final void invoke2(DescriptorRendererOptions descriptorRendererOptions) {
                        ...
                        descriptorRendererOptions.setExcludedTypeAnnotationClasses(SetsKt.plus((Set) descriptorRendererOptions.getExcludedTypeAnnotationClasses(), (Iterable) CollectionsKt.listOf(StandardNames.FqNames.extensionFunctionType)));
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        if (classifierDescriptorMo1677getDeclarationDescriptor instanceof TypeParameterDescriptor ? true : classifierDescriptorMo1677getDeclarationDescriptor instanceof ClassDescriptor ? true : classifierDescriptorMo1677getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            return renderClassifierName(classifierDescriptorMo1677getDeclarationDescriptor);
        }
        if (classifierDescriptorMo1677getDeclarationDescriptor == null) {
            return typeConstructor.toString();
        }
        throw new IllegalStateException(Intrinsics.stringPlus("Unexpected classifier: ", classifierDescriptorMo1677getDeclarationDescriptor.getClass()).toString());
    }
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) {
        ...
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo1677getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ...
        List<ValueParameterDescriptor> valueParameters = (annotationClass == null || (classConstructorDescriptorMo1669getUnsubstitutedPrimaryConstructor = annotationClass.mo1669getUnsubstitutedPrimaryConstructor()) == null) ? null : classConstructorDescriptorMo1669getUnsubstitutedPrimaryConstructor.getValueParameters();
        ...
        while (it3.hasNext()) {
            arrayList6.add(Intrinsics.stringPlus(((Name) it3.next()).asString(), " = ..."));
        }
    ...
    */
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ConstantValue<?> constantValueMo1671getCompileTimeInitializer;
        if (!getIncludePropertyConstant() || (constantValueMo1671getCompileTimeInitializer = variableDescriptor.mo1671getCompileTimeInitializer()) == null) {
            return;
        }
        sb.append(" = ");
        sb.append(escape(renderConstant(constantValueMo1671getCompileTimeInitializer)));
    }
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (classConstructorDescriptorMo1669getUnsubstitutedPrimaryConstructor = classDescriptor.mo1669getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(" ");
            renderAnnotations$default(this, sb, classConstructorDescriptorMo1669getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = classConstructorDescriptorMo1669getUnsubstitutedPrimaryConstructor.getVisibility();
            Intrinsics.checkNotNullExpressionValue(visibility2, "primaryConstructor.visibility");
            renderVisibility(visibility2, sb);
            sb.append(renderKeyword("constructor"));
            List<ValueParameterDescriptor> valueParameters = classConstructorDescriptorMo1669getUnsubstitutedPrimaryConstructor.getValueParameters();
            Intrinsics.checkNotNullExpressionValue(valueParameters, "primaryConstructor.valueParameters");
            renderValueParameters(valueParameters, classConstructorDescriptorMo1669getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        Intrinsics.checkNotNullExpressionValue(collectionMo1678getSupertypes, "klass.typeConstructor.supertypes");
        if (collectionMo1678getSupertypes.isEmpty()) {
            return;
        }
        if (collectionMo1678getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(collectionMo1678getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt.joinTo$default(collectionMo1678getSupertypes, sb, ", ", null, null, 0, null, new Function1<KotlinType, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl.renderSuperTypes.1
            {
                super(1);
            }
