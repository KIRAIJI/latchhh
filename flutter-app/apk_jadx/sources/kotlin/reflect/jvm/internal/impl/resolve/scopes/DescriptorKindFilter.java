...
public final class DescriptorKindFilter {
    ...
    static {
        ...
        int i = 2;
        ALL = new DescriptorKindFilter(companion.getALL_KINDS_MASK(), 0 == true ? 1 : 0, i, 0 == true ? 1 : 0);
        CALLABLES = new DescriptorKindFilter(companion.getCALLABLES_MASK(), 0 == true ? 1 : 0, i, 0 == true ? 1 : 0);
        NON_SINGLETON_CLASSIFIERS = new DescriptorKindFilter(companion.getNON_SINGLETON_CLASSIFIERS_MASK(), 0 == true ? 1 : 0, i, 0 == true ? 1 : 0);
        SINGLETON_CLASSIFIERS = new DescriptorKindFilter(companion.getSINGLETON_CLASSIFIERS_MASK(), 0 == true ? 1 : 0, i, 0 == true ? 1 : 0);
        TYPE_ALIASES = new DescriptorKindFilter(companion.getTYPE_ALIASES_MASK(), 0 == true ? 1 : 0, i, 0 == true ? 1 : 0);
        CLASSIFIERS = new DescriptorKindFilter(companion.getCLASSIFIERS_MASK(), 0 == true ? 1 : 0, i, 0 == true ? 1 : 0);
        PACKAGES = new DescriptorKindFilter(companion.getPACKAGES_MASK(), 0 == true ? 1 : 0, i, 0 == true ? 1 : 0);
        FUNCTIONS = new DescriptorKindFilter(companion.getFUNCTIONS_MASK(), 0 == true ? 1 : 0, i, 0 == true ? 1 : 0);
        VARIABLES = new DescriptorKindFilter(companion.getVARIABLES_MASK(), 0 == true ? 1 : 0, i, 0 == true ? 1 : 0);
        VALUES = new DescriptorKindFilter(companion.getVALUES_MASK(), 0 == true ? 1 : 0, i, 0 == true ? 1 : 0);
