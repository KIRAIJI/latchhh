...
public abstract class AbstractClassTypeConstructor extends AbstractTypeConstructor implements TypeConstructor {
    ...
    */
    ...
    public abstract ClassDescriptor mo1677getDeclarationDescriptor();
    ...
    public final int hashCode() {
        ...
        if (hasMeaningfulFqName(classDescriptorMo1677getDeclarationDescriptor)) {
            iIdentityHashCode = DescriptorUtils.getFqName(classDescriptorMo1677getDeclarationDescriptor).hashCode();
        } else {
    ...
    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = DescriptorUtilsKt.getBuiltIns(mo1677getDeclarationDescriptor());
        if (builtIns == null) {
            $$$reportNull$$$0(1);
        }
        return builtIns;
    ...
    public final boolean equals(Object obj) {
        ...
        if (hasMeaningfulFqName(classDescriptorMo1677getDeclarationDescriptor) && ((classifierDescriptorMo1677getDeclarationDescriptor == null || hasMeaningfulFqName(classifierDescriptorMo1677getDeclarationDescriptor)) && (classifierDescriptorMo1677getDeclarationDescriptor instanceof ClassDescriptor))) {
            return areFqNamesEqual(classDescriptorMo1677getDeclarationDescriptor, (ClassDescriptor) classifierDescriptorMo1677getDeclarationDescriptor);
        }
        return false;
    }
    ...
    protected Collection<KotlinType> getAdditionalNeighboursInSupertypeGraph(boolean z) {
        DeclarationDescriptor containingDeclaration = mo1677getDeclarationDescriptor().getContainingDeclaration();
        ...
        ClassDescriptor classDescriptorMo1668getCompanionObjectDescriptor = classDescriptor.mo1668getCompanionObjectDescriptor();
        if (z && classDescriptorMo1668getCompanionObjectDescriptor != null) {
            smartList.add(classDescriptorMo1668getCompanionObjectDescriptor.getDefaultType());
        }
        return smartList;
    }
    ...
    protected KotlinType defaultSupertypeIfEmpty() {
        if (KotlinBuiltIns.isSpecialClassWithNoSupertypes(mo1677getDeclarationDescriptor())) {
            return null;
        }
