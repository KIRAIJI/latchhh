...
public final class ReflectClassUtilKt {
    ...
    public static final ClassId getClassId(Class<?> cls) {
        ...
        if (cls.getEnclosingMethod() == null && cls.getEnclosingConstructor() == null) {
            ...
            if (!(simpleName.length() == 0)) {
                ...
                Intrinsics.checkNotNullExpressionValue(classIdCreateNestedClassId, "declaringClass?.classId?.createNestedClassId(Name.identifier(simpleName)) ?: ClassId.topLevel(FqName(name))");
    ...
    public static final String getDesc(Class<?> cls) {
        ...
        return StringsKt.replace$default(strSubstring, '.', '/', false, 4, (Object) null);
    }
