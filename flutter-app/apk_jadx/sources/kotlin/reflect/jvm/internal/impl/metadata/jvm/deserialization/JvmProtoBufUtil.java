...
public final class JvmProtoBufUtil {
    ...
    static {
        ...
        Intrinsics.checkNotNullExpressionValue(extensionRegistryLiteNewInstance, "newInstance().apply(JvmProtoBuf::registerAllExtensions)");
    ...
    public final JvmMemberSignature.Method getJvmMethodSignature(ProtoBuf.Function proto, NameResolver nameResolver, TypeTable typeTable) {
        ...
        if (jvmMethodSignature != null && jvmMethodSignature.hasDesc()) {
            ...
            while (it2.hasNext()) {
                String strMapTypeDefault = mapTypeDefault((ProtoBuf.Type) it2.next(), nameResolver);
            ...
            strStringPlus = Intrinsics.stringPlus(CollectionsKt.joinToString$default(arrayList3, "", "(", ")", 0, null, null, 56, null), strMapTypeDefault2);
        }
    ...
    public final JvmMemberSignature.Method getJvmConstructorSignature(ProtoBuf.Constructor proto, NameResolver nameResolver, TypeTable typeTable) {
        ...
        if (jvmMethodSignature != null && jvmMethodSignature.hasDesc()) {
            ...
            for (ProtoBuf.ValueParameter it : list) {
                Intrinsics.checkNotNullExpressionValue(it, "it");
                String strMapTypeDefault = mapTypeDefault(ProtoTypeTableUtilKt.type(it, typeTable), nameResolver);
                if (strMapTypeDefault == null) {
                    return null;
                }
