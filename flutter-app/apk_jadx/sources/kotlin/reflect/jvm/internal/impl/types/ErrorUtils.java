...
public class ErrorUtils {
    ...
    public static class ErrorScope implements MemberScope {
        ...
        */
        ...
        public ClassifierDescriptor mo1679getContributedClassifier(Name name, LookupLocation lookupLocation) {
            if (name == null) {
                $$$reportNull$$$0(1);
            }
            if (lookupLocation == null) {
    ...
    public static class UninferredParameterTypeConstructor implements TypeConstructor {
        ...
        /* JADX INFO: renamed from: getSupertypes */
        public Collection<KotlinType> mo1678getSupertypes() {
            Collection<KotlinType> collectionMo1678getSupertypes = this.errorTypeConstructor.mo1678getSupertypes();
            if (collectionMo1678getSupertypes == null) {
                $$$reportNull$$$0(3);
            }
        ...
        /* JADX INFO: renamed from: getDeclarationDescriptor */
        public ClassifierDescriptor mo1677getDeclarationDescriptor() {
            return this.errorTypeConstructor.mo1677getDeclarationDescriptor();
        }
