...
public final class KCallablesJvm {
    public static final boolean isAccessible(KCallable<?> isAccessible) {
        ...
        if (isAccessible instanceof KMutableProperty) {
            ...
            KCallableImpl<?> kCallableImplAsKCallableImpl = UtilKt.asKCallableImpl(isAccessible);
            Member memberMo1667getMember = (kCallableImplAsKCallableImpl == null || (defaultCaller = kCallableImplAsKCallableImpl.getDefaultCaller()) == null) ? null : defaultCaller.mo1667getMember();
            AccessibleObject accessibleObject = (AccessibleObject) (memberMo1667getMember instanceof AccessibleObject ? memberMo1667getMember : null);
