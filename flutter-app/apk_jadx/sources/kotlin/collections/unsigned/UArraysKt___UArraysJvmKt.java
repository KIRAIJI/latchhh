...
class UArraysKt___UArraysJvmKt {
    ...
    private static final long m864elementAtr7IrZao(long[] elementAt, int i) {
        Intrinsics.checkNotNullParameter(elementAt, "$this$elementAt");
        return ULongArray.m617getsVKNKU(elementAt, i);
    }
    ...
    private static final byte m861elementAtPpDY95g(byte[] elementAt, int i) {
        Intrinsics.checkNotNullParameter(elementAt, "$this$elementAt");
        return UByteArray.m461getw2LRezQ(elementAt, i);
    }
    ...
    private static final short m862elementAtnggk6HY(short[] elementAt, int i) {
        Intrinsics.checkNotNullParameter(elementAt, "$this$elementAt");
        return UShortArray.m721getMh2AYeg(elementAt, i);
    }
    ...
    public static /* synthetic */ int m858binarySearchK6DWlUc$default(long[] jArr, long j, int i, int i2, int i3, Object obj) {
        ...
        if ((i3 & 4) != 0) {
            i2 = ULongArray.m618getSizeimpl(jArr);
        }
    ...
    public static final int m857binarySearchK6DWlUc(long[] binarySearch, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.INSTANCE.checkRangeIndexes$kotlin_stdlib(i, i2, ULongArray.m618getSizeimpl(binarySearch));
        int i3 = i2 - 1;
        while (i <= i3) {
            int i4 = (i + i3) >>> 1;
    ...
    public static /* synthetic */ int m860binarySearchWpHrYlw$default(byte[] bArr, byte b, int i, int i2, int i3, Object obj) {
        ...
        if ((i3 & 4) != 0) {
            i2 = UByteArray.m462getSizeimpl(bArr);
        }
    ...
    public static final int m859binarySearchWpHrYlw(byte[] binarySearch, byte b, int i, int i2) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.INSTANCE.checkRangeIndexes$kotlin_stdlib(i, i2, UByteArray.m462getSizeimpl(binarySearch));
    ...
    public static /* synthetic */ int m856binarySearchEtDCXyQ$default(short[] sArr, short s, int i, int i2, int i3, Object obj) {
        ...
        if ((i3 & 4) != 0) {
            i2 = UShortArray.m722getSizeimpl(sArr);
        }
    ...
    public static final int m855binarySearchEtDCXyQ(short[] binarySearch, short s, int i, int i2) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.INSTANCE.checkRangeIndexes$kotlin_stdlib(i, i2, UShortArray.m722getSizeimpl(binarySearch));
    ...
    public static final /* synthetic */ UInt m865maxajY9A(int[] max) {
        ...
        return UArraysKt.m1245maxOrNullajY9A(max);
    }
    ...
    public static final /* synthetic */ ULong m867maxQwZRm1k(long[] max) {
        Intrinsics.checkNotNullParameter(max, "$this$max");
        return UArraysKt.m1247maxOrNullQwZRm1k(max);
    }
    ...
    public static final /* synthetic */ UByte m866maxGBYM_sE(byte[] max) {
        Intrinsics.checkNotNullParameter(max, "$this$max");
        return UArraysKt.m1246maxOrNullGBYM_sE(max);
    }
    ...
    public static final /* synthetic */ UShort m868maxrL5Bavg(short[] max) {
        Intrinsics.checkNotNullParameter(max, "$this$max");
        return UArraysKt.m1248maxOrNullrL5Bavg(max);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UInt m871maxByjgv0xPQ(int[] maxBy, Function1<? super UInt, ? extends R> selector) {
        ...
        int iM539getpVg5ArA = UIntArray.m539getpVg5ArA(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex != 0) {
            R rInvoke = selector.invoke(UInt.m474boximpl(iM539getpVg5ArA));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                int iM539getpVg5ArA2 = UIntArray.m539getpVg5ArA(maxBy, it.nextInt());
                R rInvoke2 = selector.invoke(UInt.m474boximpl(iM539getpVg5ArA2));
                if (rInvoke.compareTo(rInvoke2) < 0) {
                    iM539getpVg5ArA = iM539getpVg5ArA2;
                    rInvoke = rInvoke2;
                }
            }
        }
        return UInt.m474boximpl(iM539getpVg5ArA);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> ULong m870maxByMShoTSo(long[] maxBy, Function1<? super ULong, ? extends R> selector) {
        Intrinsics.checkNotNullParameter(maxBy, "$this$maxBy");
        Intrinsics.checkNotNullParameter(selector, "selector");
        if (ULongArray.m620isEmptyimpl(maxBy)) {
            return null;
        }
        long jM617getsVKNKU = ULongArray.m617getsVKNKU(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex != 0) {
            R rInvoke = selector.invoke(ULong.m552boximpl(jM617getsVKNKU));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                long jM617getsVKNKU2 = ULongArray.m617getsVKNKU(maxBy, it.nextInt());
                R rInvoke2 = selector.invoke(ULong.m552boximpl(jM617getsVKNKU2));
                if (rInvoke.compareTo(rInvoke2) < 0) {
                    jM617getsVKNKU = jM617getsVKNKU2;
                    rInvoke = rInvoke2;
                }
            }
        }
        return ULong.m552boximpl(jM617getsVKNKU);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UByte m869maxByJOV_ifY(byte[] maxBy, Function1<? super UByte, ? extends R> selector) {
        Intrinsics.checkNotNullParameter(maxBy, "$this$maxBy");
        Intrinsics.checkNotNullParameter(selector, "selector");
        if (UByteArray.m464isEmptyimpl(maxBy)) {
            return null;
        }
        byte bM461getw2LRezQ = UByteArray.m461getw2LRezQ(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex != 0) {
            R rInvoke = selector.invoke(UByte.m398boximpl(bM461getw2LRezQ));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                byte bM461getw2LRezQ2 = UByteArray.m461getw2LRezQ(maxBy, it.nextInt());
                R rInvoke2 = selector.invoke(UByte.m398boximpl(bM461getw2LRezQ2));
                if (rInvoke.compareTo(rInvoke2) < 0) {
                    bM461getw2LRezQ = bM461getw2LRezQ2;
                    rInvoke = rInvoke2;
                }
            }
        }
        return UByte.m398boximpl(bM461getw2LRezQ);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UShort m872maxByxTcfx_M(short[] maxBy, Function1<? super UShort, ? extends R> selector) {
        Intrinsics.checkNotNullParameter(maxBy, "$this$maxBy");
        Intrinsics.checkNotNullParameter(selector, "selector");
        if (UShortArray.m724isEmptyimpl(maxBy)) {
            return null;
        }
        short sM721getMh2AYeg = UShortArray.m721getMh2AYeg(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex != 0) {
            R rInvoke = selector.invoke(UShort.m658boximpl(sM721getMh2AYeg));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                short sM721getMh2AYeg2 = UShortArray.m721getMh2AYeg(maxBy, it.nextInt());
                R rInvoke2 = selector.invoke(UShort.m658boximpl(sM721getMh2AYeg2));
                if (rInvoke.compareTo(rInvoke2) < 0) {
                    sM721getMh2AYeg = sM721getMh2AYeg2;
                    rInvoke = rInvoke2;
                }
            }
        }
        return UShort.m658boximpl(sM721getMh2AYeg);
    }
    ...
    public static final /* synthetic */ UInt m874maxWithYmdZ_VM(int[] maxWith, Comparator comparator) {
        ...
        return UArraysKt.m1254maxWithOrNullYmdZ_VM(maxWith, comparator);
    }
    ...
    public static final /* synthetic */ ULong m876maxWithzrEWJaI(long[] maxWith, Comparator comparator) {
        Intrinsics.checkNotNullParameter(maxWith, "$this$maxWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m1256maxWithOrNullzrEWJaI(maxWith, comparator);
    }
    ...
    public static final /* synthetic */ UByte m873maxWithXMRcp5o(byte[] maxWith, Comparator comparator) {
        Intrinsics.checkNotNullParameter(maxWith, "$this$maxWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m1253maxWithOrNullXMRcp5o(maxWith, comparator);
    }
    ...
    public static final /* synthetic */ UShort m875maxWitheOHTfZs(short[] maxWith, Comparator comparator) {
        Intrinsics.checkNotNullParameter(maxWith, "$this$maxWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m1255maxWithOrNulleOHTfZs(maxWith, comparator);
    }
    ...
    public static final /* synthetic */ UInt m877minajY9A(int[] min) {
        ...
        return UArraysKt.m1301minOrNullajY9A(min);
    }
    ...
    public static final /* synthetic */ ULong m879minQwZRm1k(long[] min) {
        Intrinsics.checkNotNullParameter(min, "$this$min");
        return UArraysKt.m1303minOrNullQwZRm1k(min);
    }
    ...
    public static final /* synthetic */ UByte m878minGBYM_sE(byte[] min) {
        Intrinsics.checkNotNullParameter(min, "$this$min");
        return UArraysKt.m1302minOrNullGBYM_sE(min);
    }
    ...
    public static final /* synthetic */ UShort m880minrL5Bavg(short[] min) {
        Intrinsics.checkNotNullParameter(min, "$this$min");
        return UArraysKt.m1304minOrNullrL5Bavg(min);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UInt m883minByjgv0xPQ(int[] minBy, Function1<? super UInt, ? extends R> selector) {
        ...
        int iM539getpVg5ArA = UIntArray.m539getpVg5ArA(minBy, 0);
        int lastIndex = ArraysKt.getLastIndex(minBy);
        if (lastIndex != 0) {
            R rInvoke = selector.invoke(UInt.m474boximpl(iM539getpVg5ArA));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                int iM539getpVg5ArA2 = UIntArray.m539getpVg5ArA(minBy, it.nextInt());
                R rInvoke2 = selector.invoke(UInt.m474boximpl(iM539getpVg5ArA2));
                if (rInvoke.compareTo(rInvoke2) > 0) {
                    iM539getpVg5ArA = iM539getpVg5ArA2;
                    rInvoke = rInvoke2;
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> ULong m882minByMShoTSo(long[] minBy, Function1<? super ULong, ? extends R> selector) {
        Intrinsics.checkNotNullParameter(minBy, "$this$minBy");
        Intrinsics.checkNotNullParameter(selector, "selector");
        if (ULongArray.m620isEmptyimpl(minBy)) {
            return null;
        }
        long jM617getsVKNKU = ULongArray.m617getsVKNKU(minBy, 0);
        int lastIndex = ArraysKt.getLastIndex(minBy);
        if (lastIndex != 0) {
            R rInvoke = selector.invoke(ULong.m552boximpl(jM617getsVKNKU));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                long jM617getsVKNKU2 = ULongArray.m617getsVKNKU(minBy, it.nextInt());
                R rInvoke2 = selector.invoke(ULong.m552boximpl(jM617getsVKNKU2));
                if (rInvoke.compareTo(rInvoke2) > 0) {
                    jM617getsVKNKU = jM617getsVKNKU2;
                    rInvoke = rInvoke2;
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UByte m881minByJOV_ifY(byte[] minBy, Function1<? super UByte, ? extends R> selector) {
        Intrinsics.checkNotNullParameter(minBy, "$this$minBy");
        Intrinsics.checkNotNullParameter(selector, "selector");
        if (UByteArray.m464isEmptyimpl(minBy)) {
            return null;
        }
        byte bM461getw2LRezQ = UByteArray.m461getw2LRezQ(minBy, 0);
        int lastIndex = ArraysKt.getLastIndex(minBy);
        if (lastIndex != 0) {
            R rInvoke = selector.invoke(UByte.m398boximpl(bM461getw2LRezQ));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                byte bM461getw2LRezQ2 = UByteArray.m461getw2LRezQ(minBy, it.nextInt());
                R rInvoke2 = selector.invoke(UByte.m398boximpl(bM461getw2LRezQ2));
                if (rInvoke.compareTo(rInvoke2) > 0) {
                    bM461getw2LRezQ = bM461getw2LRezQ2;
                    rInvoke = rInvoke2;
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UShort m884minByxTcfx_M(short[] minBy, Function1<? super UShort, ? extends R> selector) {
        Intrinsics.checkNotNullParameter(minBy, "$this$minBy");
        Intrinsics.checkNotNullParameter(selector, "selector");
        if (UShortArray.m724isEmptyimpl(minBy)) {
            return null;
        }
        short sM721getMh2AYeg = UShortArray.m721getMh2AYeg(minBy, 0);
        int lastIndex = ArraysKt.getLastIndex(minBy);
        if (lastIndex != 0) {
            R rInvoke = selector.invoke(UShort.m658boximpl(sM721getMh2AYeg));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                short sM721getMh2AYeg2 = UShortArray.m721getMh2AYeg(minBy, it.nextInt());
                R rInvoke2 = selector.invoke(UShort.m658boximpl(sM721getMh2AYeg2));
                if (rInvoke.compareTo(rInvoke2) > 0) {
                    sM721getMh2AYeg = sM721getMh2AYeg2;
                    rInvoke = rInvoke2;
    ...
    public static final /* synthetic */ UInt m886minWithYmdZ_VM(int[] minWith, Comparator comparator) {
        ...
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m1310minWithOrNullYmdZ_VM(minWith, comparator);
    }
    ...
    public static final /* synthetic */ ULong m888minWithzrEWJaI(long[] minWith, Comparator comparator) {
        Intrinsics.checkNotNullParameter(minWith, "$this$minWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m1312minWithOrNullzrEWJaI(minWith, comparator);
    }
    ...
    public static final /* synthetic */ UByte m885minWithXMRcp5o(byte[] minWith, Comparator comparator) {
        Intrinsics.checkNotNullParameter(minWith, "$this$minWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m1309minWithOrNullXMRcp5o(minWith, comparator);
    }
    ...
    public static final /* synthetic */ UShort m887minWitheOHTfZs(short[] minWith, Comparator comparator) {
        Intrinsics.checkNotNullParameter(minWith, "$this$minWith");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt.m1311minWithOrNulleOHTfZs(minWith, comparator);
    }
    ...
    private static final BigDecimal sumOfBigDecimal(int[] sumOf, Function1<? super UInt, ? extends BigDecimal> selector) {
        ...
        int iM540getSizeimpl = UIntArray.m540getSizeimpl(sumOf);
        for (int i = 0; i < iM540getSizeimpl; i++) {
            bigDecimalValueOf = bigDecimalValueOf.add(selector.invoke(UInt.m474boximpl(UIntArray.m539getpVg5ArA(sumOf, i))));
    ...
    private static final BigDecimal sumOfBigDecimal(long[] sumOf, Function1<? super ULong, ? extends BigDecimal> selector) {
        ...
        BigDecimal bigDecimalValueOf = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(bigDecimalValueOf, "valueOf(this.toLong())");
        int iM618getSizeimpl = ULongArray.m618getSizeimpl(sumOf);
        for (int i = 0; i < iM618getSizeimpl; i++) {
            bigDecimalValueOf = bigDecimalValueOf.add(selector.invoke(ULong.m552boximpl(ULongArray.m617getsVKNKU(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(bigDecimalValueOf, "this.add(other)");
        }
        return bigDecimalValueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(byte[] sumOf, Function1<? super UByte, ? extends BigDecimal> selector) {
        ...
        BigDecimal bigDecimalValueOf = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(bigDecimalValueOf, "valueOf(this.toLong())");
        int iM462getSizeimpl = UByteArray.m462getSizeimpl(sumOf);
        for (int i = 0; i < iM462getSizeimpl; i++) {
            bigDecimalValueOf = bigDecimalValueOf.add(selector.invoke(UByte.m398boximpl(UByteArray.m461getw2LRezQ(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(bigDecimalValueOf, "this.add(other)");
        }
        return bigDecimalValueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(short[] sumOf, Function1<? super UShort, ? extends BigDecimal> selector) {
        ...
        BigDecimal bigDecimalValueOf = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(bigDecimalValueOf, "valueOf(this.toLong())");
        int iM722getSizeimpl = UShortArray.m722getSizeimpl(sumOf);
        for (int i = 0; i < iM722getSizeimpl; i++) {
            bigDecimalValueOf = bigDecimalValueOf.add(selector.invoke(UShort.m658boximpl(UShortArray.m721getMh2AYeg(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(bigDecimalValueOf, "this.add(other)");
        }
        return bigDecimalValueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(int[] sumOf, Function1<? super UInt, ? extends BigInteger> selector) {
        ...
        int iM540getSizeimpl = UIntArray.m540getSizeimpl(sumOf);
        for (int i = 0; i < iM540getSizeimpl; i++) {
            bigIntegerValueOf = bigIntegerValueOf.add(selector.invoke(UInt.m474boximpl(UIntArray.m539getpVg5ArA(sumOf, i))));
    ...
    private static final BigInteger sumOfBigInteger(long[] sumOf, Function1<? super ULong, ? extends BigInteger> selector) {
        ...
        int iM618getSizeimpl = ULongArray.m618getSizeimpl(sumOf);
        for (int i = 0; i < iM618getSizeimpl; i++) {
            bigIntegerValueOf = bigIntegerValueOf.add(selector.invoke(ULong.m552boximpl(ULongArray.m617getsVKNKU(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(bigIntegerValueOf, "this.add(other)");
        }
        return bigIntegerValueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(byte[] sumOf, Function1<? super UByte, ? extends BigInteger> selector) {
        ...
        int iM462getSizeimpl = UByteArray.m462getSizeimpl(sumOf);
        for (int i = 0; i < iM462getSizeimpl; i++) {
            bigIntegerValueOf = bigIntegerValueOf.add(selector.invoke(UByte.m398boximpl(UByteArray.m461getw2LRezQ(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(bigIntegerValueOf, "this.add(other)");
        }
        return bigIntegerValueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(short[] sumOf, Function1<? super UShort, ? extends BigInteger> selector) {
        ...
        int iM722getSizeimpl = UShortArray.m722getSizeimpl(sumOf);
        for (int i = 0; i < iM722getSizeimpl; i++) {
            bigIntegerValueOf = bigIntegerValueOf.add(selector.invoke(UShort.m658boximpl(UShortArray.m721getMh2AYeg(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(bigIntegerValueOf, "this.add(other)");
        }
        return bigIntegerValueOf;
    }
