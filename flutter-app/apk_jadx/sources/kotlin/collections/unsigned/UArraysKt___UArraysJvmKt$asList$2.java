...
public final class UArraysKt___UArraysJvmKt$asList$2 extends AbstractList<ULong> implements RandomAccess {
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return ULong.m552boximpl(m894getsVKNKU(i));
    }
    ...
    public int getSize() {
        return ULongArray.m618getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return ULongArray.m620isEmptyimpl(this.$this_asList);
    }

    /* JADX INFO: renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m893containsVKZWuLQ(long element) {
        return ULongArray.m613containsVKZWuLQ(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: get-s-VKNKU, reason: not valid java name */
    public long m894getsVKNKU(int index) {
        return ULongArray.m617getsVKNKU(this.$this_asList, index);
    }
