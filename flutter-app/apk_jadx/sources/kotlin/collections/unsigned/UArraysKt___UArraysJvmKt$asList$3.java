...
public final class UArraysKt___UArraysJvmKt$asList$3 extends AbstractList<UByte> implements RandomAccess {
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return UByte.m398boximpl(m898getw2LRezQ(i));
    }
    ...
    public int getSize() {
        return UByteArray.m462getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return UByteArray.m464isEmptyimpl(this.$this_asList);
    }

    /* JADX INFO: renamed from: contains-7apg3OU, reason: not valid java name */
    public boolean m897contains7apg3OU(byte element) {
        return UByteArray.m457contains7apg3OU(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: get-w2LRezQ, reason: not valid java name */
    public byte m898getw2LRezQ(int index) {
        return UByteArray.m461getw2LRezQ(this.$this_asList, index);
    }
