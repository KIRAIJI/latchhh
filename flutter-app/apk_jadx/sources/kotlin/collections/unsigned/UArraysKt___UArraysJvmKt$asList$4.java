...
public final class UArraysKt___UArraysJvmKt$asList$4 extends AbstractList<UShort> implements RandomAccess {
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return UShort.m658boximpl(m902getMh2AYeg(i));
    }
    ...
    public int getSize() {
        return UShortArray.m722getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return UShortArray.m724isEmptyimpl(this.$this_asList);
    }

    /* JADX INFO: renamed from: contains-xj2QHRw, reason: not valid java name */
    public boolean m901containsxj2QHRw(short element) {
        return UShortArray.m717containsxj2QHRw(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: get-Mh2AYeg, reason: not valid java name */
    public short m902getMh2AYeg(int index) {
        return UShortArray.m721getMh2AYeg(this.$this_asList, index);
    }
