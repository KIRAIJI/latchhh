...
public final class URandomKt {
    public static final int nextUInt(Random random) {
        ...
        return UInt.m480constructorimpl(random.nextInt());
    }
    ...
    public static final int m1611nextUInta8DCA5k(Random nextUInt, int i, int i2) {
        ...
        return UInt.m480constructorimpl(nextUInt.nextInt(i ^ Integer.MIN_VALUE, i2 ^ Integer.MIN_VALUE) ^ Integer.MIN_VALUE);
    }
    ...
    public static final int nextUInt(Random random, UIntRange range) {
        ...
        if (!range.isEmpty()) {
            return UnsignedKt.uintCompare(range.getLast(), -1) < 0 ? m1611nextUInta8DCA5k(random, range.getFirst(), UInt.m480constructorimpl(range.getLast() + 1)) : UnsignedKt.uintCompare(range.getFirst(), 0) > 0 ? UInt.m480constructorimpl(m1611nextUInta8DCA5k(random, UInt.m480constructorimpl(range.getFirst() - 1), range.getLast()) + 1) : nextUInt(random);
        }
    ...
    public static final long nextULong(Random random, ULongRange range) {
        ...
        if (UnsignedKt.ulongCompare(range.getLast(), -1L) < 0) {
            return m1614nextULongjmpaWc(random, range.getFirst(), ULong.m558constructorimpl(range.getLast() + ULong.m558constructorimpl(((long) 1) & 4294967295L)));
        }
        if (UnsignedKt.ulongCompare(range.getFirst(), 0L) <= 0) {
            return nextULong(random);
        }
        long j = ((long) 1) & 4294967295L;
        return ULong.m558constructorimpl(m1614nextULongjmpaWc(random, ULong.m558constructorimpl(range.getFirst() - ULong.m558constructorimpl(j)), range.getLast()) + ULong.m558constructorimpl(j));
    }
    ...
    public static final byte[] nextUBytes(Random random, int i) {
        Intrinsics.checkNotNullParameter(random, "<this>");
        return UByteArray.m456constructorimpl(random.nextBytes(i));
    }
    ...
    public static final void m1606checkUIntRangeBoundsJ1ME1BU(int i, int i2) {
        if (!(UnsignedKt.uintCompare(i2, i) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(UInt.m474boximpl(i), UInt.m474boximpl(i2)).toString());
        }
    }
