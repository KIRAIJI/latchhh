...
public final class Utf8 {
    ...
    public static final boolean isUtf8Continuation(byte b) {
        return (b & Constants.TLV_APPID) == 128;
    }
            ...
            if (b >= 0) {
                ...
                if ((b >> 5) == -2) {
                    ...
                    if (i2 <= i7) {
                        ...
                        int i8 = i4 + 1;
                        if (i2 > i8) {
                            if ((processUtf8CodePoints[i8] & Constants.TLV_APPID) == 128) {
                                i3 = 2;
                            }
                        }
                        i3 = 1;
                        ...
                        if ((b5 & Constants.TLV_APPID) == 128) {
                            byte b6 = processUtf8CodePoints[i7];
                            if ((b6 & Constants.TLV_APPID) == 128) {
                    ...
                    if (i2 <= i10) {
                        ...
                        int i11 = i4 + 1;
                        if (i2 > i11) {
                            if ((processUtf8CodePoints[i11] & Constants.TLV_APPID) == 128) {
                                int i12 = i4 + 2;
                                if (i2 > i12) {
                                    if ((processUtf8CodePoints[i12] & Constants.TLV_APPID) == 128) {
                                        i3 = 3;
                                    }
                                }
                                i3 = 2;
                        ...
                        if ((b8 & Constants.TLV_APPID) == 128) {
                            byte b9 = processUtf8CodePoints[i4 + 2];
                            if ((b9 & Constants.TLV_APPID) == 128) {
                                byte b10 = processUtf8CodePoints[i10];
                                if ((b10 & Constants.TLV_APPID) == 128) {
            ...
            if (b >= 0) {
                ...
                if ((b >> 5) == -2) {
                    ...
                    if (i2 <= i7) {
                        ...
                        int i8 = i4 + 1;
                        if (i2 > i8) {
                            if ((processUtf16Chars[i8] & Constants.TLV_APPID) == 128) {
                                i3 = 2;
                            }
                        }
                        i3 = 1;
                    ...
                    if (i2 <= i10) {
                        ...
                        int i11 = i4 + 1;
                        if (i2 > i11) {
                            if ((processUtf16Chars[i11] & Constants.TLV_APPID) == 128) {
                                int i12 = i4 + 2;
                                if (i2 > i12) {
                                    if ((processUtf16Chars[i12] & Constants.TLV_APPID) == 128) {
                                        i3 = 3;
                                    }
                                }
                                i3 = 2;
    ...
    public static final int process3Utf8Bytes(byte[] process3Utf8Bytes, int i, int i2, Function1<? super Integer, Unit> yield) {
        ...
        if (i2 <= i3) {
            ...
            int i4 = i + 1;
            if (i2 > i4) {
                if ((process3Utf8Bytes[i4] & Constants.TLV_APPID) == 128) {
                    return 2;
                }
            }
            return 1;
    ...
    public static final int process4Utf8Bytes(byte[] process4Utf8Bytes, int i, int i2, Function1<? super Integer, Unit> yield) {
        ...
        if (i2 <= i3) {
            ...
            int i4 = i + 1;
            if (i2 > i4) {
                if ((process4Utf8Bytes[i4] & Constants.TLV_APPID) == 128) {
                    int i5 = i + 2;
                    if (i2 > i5) {
                        if ((process4Utf8Bytes[i5] & Constants.TLV_APPID) == 128) {
                            return 3;
                        }
                    }
                    return 2;
