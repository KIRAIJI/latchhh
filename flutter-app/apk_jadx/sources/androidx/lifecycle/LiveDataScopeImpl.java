...
public final class LiveDataScopeImpl<T> implements LiveDataScope<T> {
    ...
    static final class C00402 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super DisposableHandle>, Object> {
        final /* synthetic */ LiveData $source;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00402(LiveData liveData, Continuation continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            ...
            return new C00402(this.$source, completion);
        }
    ...
    public Object emitSource(LiveData<T> liveData, Continuation<? super DisposableHandle> continuation) {
        return BuildersKt.withContext(this.coroutineContext, new C00402(liveData, null), continuation);
    }
