...
final class QueryInterceptorDatabase implements SupportSQLiteDatabase {
    ...
    public void beginTransaction() {
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m37lambda$beginTransaction$0$androidxroomQueryInterceptorDatabase();
            }
        });
    ...
    public /* synthetic */ void m37lambda$beginTransaction$0$androidxroomQueryInterceptorDatabase() {
    ...
    public /* synthetic */ void m38x9d2bf0fa() {
    ...
    public /* synthetic */ void m39xe4527eb0() {
        this.mQueryCallback.onQuery("BEGIN EXCLUSIVE TRANSACTION", Collections.emptyList());
    }
    ...
    public /* synthetic */ void m40xa78c463e() {
        this.mQueryCallback.onQuery("BEGIN DEFERRED TRANSACTION", Collections.emptyList());
    }
    ...
    public void endTransaction() {
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m41lambda$endTransaction$4$androidxroomQueryInterceptorDatabase();
            }
        });
    ...
    public /* synthetic */ void m41lambda$endTransaction$4$androidxroomQueryInterceptorDatabase() {
    ...
    public /* synthetic */ void m48x7d646086() {
    ...
    public /* synthetic */ void m44lambda$query$6$androidxroomQueryInterceptorDatabase(String str) {
    ...
    public Cursor query(final String str) {
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m44lambda$query$6$androidxroomQueryInterceptorDatabase(str);
            }
        });
    ...
    public Cursor query(final String str, Object[] objArr) {
        ...
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m45lambda$query$7$androidxroomQueryInterceptorDatabase(str, arrayList);
            }
        });
    ...
    public /* synthetic */ void m45lambda$query$7$androidxroomQueryInterceptorDatabase(String str, List list) {
    ...
    public Cursor query(final SupportSQLiteQuery supportSQLiteQuery) {
        ...
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m46lambda$query$8$androidxroomQueryInterceptorDatabase(supportSQLiteQuery, queryInterceptorProgram);
            }
        });
    ...
    public /* synthetic */ void m46lambda$query$8$androidxroomQueryInterceptorDatabase(SupportSQLiteQuery supportSQLiteQuery, QueryInterceptorProgram queryInterceptorProgram) {
    ...
    public Cursor query(final SupportSQLiteQuery supportSQLiteQuery, CancellationSignal cancellationSignal) {
        ...
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m47lambda$query$9$androidxroomQueryInterceptorDatabase(supportSQLiteQuery, queryInterceptorProgram);
            }
        });
        return this.mDelegate.query(supportSQLiteQuery);
    }
    ...
    public /* synthetic */ void m47lambda$query$9$androidxroomQueryInterceptorDatabase(SupportSQLiteQuery supportSQLiteQuery, QueryInterceptorProgram queryInterceptorProgram) {
        this.mQueryCallback.onQuery(supportSQLiteQuery.getSql(), queryInterceptorProgram.getBindArgs());
    }
    ...
    public void execSQL(final String str) throws SQLException {
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m42lambda$execSQL$10$androidxroomQueryInterceptorDatabase(str);
            }
        });
    ...
    public /* synthetic */ void m42lambda$execSQL$10$androidxroomQueryInterceptorDatabase(String str) {
    ...
    public void execSQL(final String str, Object[] objArr) throws SQLException {
        ...
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m43lambda$execSQL$11$androidxroomQueryInterceptorDatabase(str, arrayList);
            }
        });
    ...
    public /* synthetic */ void m43lambda$execSQL$11$androidxroomQueryInterceptorDatabase(String str, List list) {
        this.mQueryCallback.onQuery(str, list);
    }
