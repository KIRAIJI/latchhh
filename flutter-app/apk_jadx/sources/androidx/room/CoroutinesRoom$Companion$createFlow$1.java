...
final class CoroutinesRoom$Companion$createFlow$1<R> extends SuspendLambda implements Function2<FlowCollector<R>, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            if (i == 0) {
                ...
                ?? r7 = new InvalidationTracker.Observer(strArr, channelChannel$default) { // from class: androidx.room.CoroutinesRoom$Companion$createFlow$1$1$observer$1
                    ...
                    public void onInvalidated(Set<String> tables) {
                        ...
                        this.$observerChannel.mo1902trySendJP2dKIU(Unit.INSTANCE);
                    }
                };
                channelChannel$default.mo1902trySendJP2dKIU(Unit.INSTANCE);
                ...
                BuildersKt__Builders_commonKt.launch$default(coroutineScope, transactionDispatcher, null, new C00061(this.$db, r7, channelChannel$default, this.$callable, channelChannel$default2, null), 2, null);
                this.label = 1;
        ...
        static final class C00061 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00061(RoomDatabase roomDatabase, CoroutinesRoom$Companion$createFlow$1$1$observer$1 coroutinesRoom$Companion$createFlow$1$1$observer$1, Channel<Unit> channel, Callable<R> callable, Channel<R> channel2, Continuation<? super C00061> continuation) {
                super(2, continuation);
                this.$db = roomDatabase;
