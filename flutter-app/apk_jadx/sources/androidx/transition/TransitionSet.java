...
public class TransitionSet extends Transition {
    ...
    public Transition mo56clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo56clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo56clone());
        }
