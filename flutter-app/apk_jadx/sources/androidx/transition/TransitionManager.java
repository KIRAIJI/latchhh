...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo56clone = transition.mo56clone();
        transitionMo56clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo56clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo56clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo56clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo56clone = transition.mo56clone();
        sceneChangeSetup(viewGroup, transitionMo56clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo56clone);
    }
