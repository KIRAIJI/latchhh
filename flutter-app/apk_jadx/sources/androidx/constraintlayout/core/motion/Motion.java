    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (motionPathsArr[i8].customAttributes.containsKey(str7) && (customVariable = motionPathsArr[i8].customAttributes.get(str7)) != null) {
        ...
        while (true) {
            ...
            if (iArr2[i15] < MotionPaths.names.length) {
                String str8 = MotionPaths.names[this.mInterpolateVariables[i15]] + " [";
            ...
            while (i18 < size) {
                if (motionPathsArr[i18].hasCustomData(str9)) {
                    if (dArr4 == null) {
                        ...
                        iArr3[1] = motionPathsArr[i18].getCustomDataCount(str9);
                        iArr3[0] = size;
                    ...
                    motionPathsArr[i18].getCustomData(str9, dArr4[i19], i3);
                    i19++;
                } else {
                    cls = cls2;
                }
