...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1947scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1886delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1887toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1887toDelayMillisLRDsOJo(long j) {
        if (Duration.m1723compareToLRDsOJo(j, Duration.INSTANCE.m1826getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1742getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
