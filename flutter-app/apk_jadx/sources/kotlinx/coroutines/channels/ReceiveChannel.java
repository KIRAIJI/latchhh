...
public interface ReceiveChannel<E> {
    ...
    Object mo1900receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1901tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1901tryReceivePtdJZtk = receiveChannel.mo1901tryReceivePtdJZtk();
            if (ChannelResult.m1917isSuccessimpl(objMo1901tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1913getOrThrowimpl(objMo1901tryReceivePtdJZtk);
            }
            Throwable thM1911exceptionOrNullimpl = ChannelResult.m1911exceptionOrNullimpl(objMo1901tryReceivePtdJZtk);
            if (thM1911exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1911exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) throws java.lang.Throwable {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo1900receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m1912getOrNullimpl(r4)
                return r4
            */
