...
public interface SendChannel<E> {
    ...
    Object mo1902trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m1917isSuccessimpl(objMo1902trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1911exceptionOrNullimpl = ChannelResult.m1911exceptionOrNullimpl(objMo1902trySendJP2dKIU);
