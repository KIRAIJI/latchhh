...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1917isSuccessimpl(sendChannel.mo1902trySendJP2dKIU(e))) {
            return;
        }
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM386constructorimpl = Result.m386constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM386constructorimpl = Result.m386constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m1907boximpl(Result.m393isSuccessimpl(objM386constructorimpl) ? ChannelResult.INSTANCE.m1922successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1920closedJP2dKIU(Result.m389exceptionOrNullimpl(objM386constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) throws InterruptedException {
        Object objMo1902trySendJP2dKIU = sendChannel.mo1902trySendJP2dKIU(e);
        if (objMo1902trySendJP2dKIU instanceof ChannelResult.Failed) {
