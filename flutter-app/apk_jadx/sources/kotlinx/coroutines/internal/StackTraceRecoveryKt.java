...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM386constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM386constructorimpl = Result.m386constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM386constructorimpl = Result.m386constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m389exceptionOrNullimpl(objM386constructorimpl) == null) {
            obj2 = objM386constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM386constructorimpl2 = Result.m386constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM386constructorimpl2 = Result.m386constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m389exceptionOrNullimpl(objM386constructorimpl2) == null) {
            obj = objM386constructorimpl2;
        }
