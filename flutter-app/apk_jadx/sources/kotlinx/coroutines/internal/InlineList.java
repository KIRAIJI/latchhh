...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m1936boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <E> Object m1937constructorimpl(Object obj) {
        return obj;
    }
    ...
    public boolean equals(Object obj) {
        return m1939equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m1942hashCodeimpl(this.holder);
    }

    public String toString() {
        return m1944toStringimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m1938constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m1937constructorimpl(obj);
    }

    /* JADX INFO: renamed from: plus-FjFbRPM, reason: not valid java name */
    public static final Object m1943plusFjFbRPM(Object obj, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(e instanceof List))) {
            throw new AssertionError();
        }
        if (obj == null) {
            return m1937constructorimpl(e);
        }
        ...
        arrayList.add(obj);
        arrayList.add(e);
        return m1937constructorimpl(arrayList);
    }

    /* JADX INFO: renamed from: forEachReversed-impl, reason: not valid java name */
    public static final void m1941forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj == null) {
            return;
        }
        if (!(obj instanceof ArrayList)) {
