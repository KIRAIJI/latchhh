...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM386constructorimpl = Result.m386constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM386constructorimpl = Result.m386constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m392isFailureimpl(objM386constructorimpl) ? null : objM386constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1924installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1924installSignalHandler$lambda1(Signal signal) {
