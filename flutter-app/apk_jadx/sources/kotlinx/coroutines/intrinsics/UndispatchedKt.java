        ...
        try {
            if (function1 != null) {
                ...
                if (objInvoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    continuationProbeCoroutineCreated.resumeWith(Result.m386constructorimpl(objInvoke));
                    return;
                }
                return;
            }
            ...
            continuationProbeCoroutineCreated.resumeWith(Result.m386constructorimpl(ResultKt.createFailure(th)));
        }
    }
