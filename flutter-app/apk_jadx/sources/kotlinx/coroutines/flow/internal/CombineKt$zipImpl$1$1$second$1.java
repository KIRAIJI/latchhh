...
final class CombineKt$zipImpl$1$1$second$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            FlowCollector flowCollector = new FlowCollector<T2>() { // from class: kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1$second$1$invokeSuspend$$inlined$collect$1
                ...
                public Object emit(T2 t2, Continuation<? super Unit> continuation) {
                    ...
                    Object objSend = channel.send(t2, continuation);
                    return objSend == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objSend : Unit.INSTANCE;
                }
            };
            this.label = 1;
            if (flow.collect((FlowCollector<? super T2>) flowCollector, this) == coroutine_suspended) {
