...
final /* synthetic */ class FlowKt__BuildersKt {
    ...
    /* JADX INFO: renamed from: kotlinx.coroutines.flow.FlowKt__BuildersKt$flowViaChannel$1, reason: invalid class name */
    /* JADX INFO: compiled from: Builders.kt */
    ...
    static final class AnonymousClass1<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        AnonymousClass1(Function2<? super CoroutineScope, ? super SendChannel<? super T>, Unit> function2, Continuation<? super AnonymousClass1> continuation) {
    ...
    public static final <T> Flow<T> flowViaChannel(int i, Function2<? super CoroutineScope, ? super SendChannel<? super T>, Unit> function2) {
        return FlowKt__ContextKt.buffer$default(FlowKt.channelFlow(new AnonymousClass1(function2, null)), i, null, 2, null);
    }
