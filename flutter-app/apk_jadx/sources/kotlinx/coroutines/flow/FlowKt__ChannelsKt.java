    ...
    */
    public static final <T> java.lang.Object emitAllImpl$FlowKt__ChannelsKt(kotlinx.coroutines.flow.FlowCollector<? super T> r7, kotlinx.coroutines.channels.ReceiveChannel<? extends T> r8, boolean r9, kotlin.coroutines.Continuation<? super kotlin.Unit> r10) throws java.lang.Throwable {
        ...
        L5e:
            ...
            java.lang.Object r10 = r8.mo1900receiveCatchingJP2dKIU(r0)     // Catch: java.lang.Throwable -> L99
            if (r10 != r1) goto L6d
            return r1
        L6d:
            r6 = r9
        ...
        L70:
            r2 = 0
            boolean r5 = kotlinx.coroutines.channels.ChannelResult.m1915isClosedimpl(r10)     // Catch: java.lang.Throwable -> L56
            if (r5 == 0) goto L86
            java.lang.Throwable r9 = kotlinx.coroutines.channels.ChannelResult.m1911exceptionOrNullimpl(r10)     // Catch: java.lang.Throwable -> L56
            if (r9 != 0) goto L85
            if (r7 == 0) goto L82
        ...
        L86:
            java.lang.Object r10 = kotlinx.coroutines.channels.ChannelResult.m1913getOrThrowimpl(r10)     // Catch: java.lang.Throwable -> L56
    ...
    public static final <T> BroadcastChannel<T> broadcastIn(Flow<? extends T> flow, CoroutineScope coroutineScope, CoroutineStart coroutineStart) {
        ...
        ChannelFlow channelFlowAsChannelFlow = ChannelFlowKt.asChannelFlow(flow);
        int i = WhenMappings.$EnumSwitchMapping$0[channelFlowAsChannelFlow.onBufferOverflow.ordinal()];
        if (i == 1) {
            produceCapacity$kotlinx_coroutines_core = channelFlowAsChannelFlow.getProduceCapacity$kotlinx_coroutines_core();
        } else {
            if (i != 2) {
                if (i != 3) {
        ...
        return BroadcastKt.broadcast$default(coroutineScope, channelFlowAsChannelFlow.context, produceCapacity$kotlinx_coroutines_core, coroutineStart, null, new AnonymousClass1(flow, null), 8, null);
    }
