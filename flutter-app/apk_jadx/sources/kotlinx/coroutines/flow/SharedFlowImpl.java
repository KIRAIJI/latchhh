...
final class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:41:0x00bf -> B:15:0x003f). Please report as a decompilation issue!!! */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:71:0x00f1 A[PHI: r12
  0x00f1: PHI (r12v1 kotlin.coroutines.Continuation<kotlin.Unit>[]) = (r12v0 kotlin.coroutines.Continuation<kotlin.Unit>[]), (r12v4 kotlin.coroutines.Continuation<kotlin.Unit>[]) binds: [B:56:0x00a4, B:58:0x00af] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        while (i < length) {
            ...
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m386constructorimpl(unit2));
            }
        }
