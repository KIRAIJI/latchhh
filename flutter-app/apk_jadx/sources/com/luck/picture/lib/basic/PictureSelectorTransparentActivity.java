...
public class PictureSelectorTransparentActivity extends AppCompatActivity {
    ...
    private void setupFragment() {
        ...
        if (intExtra == 1) {
            ...
            PictureSelectorPreviewFragment pictureSelectorPreviewFragmentOnInjectPreviewFragment = this.selectorConfig.onInjectActivityPreviewListener != null ? this.selectorConfig.onInjectActivityPreviewListener.onInjectPreviewFragment() : null;
            if (pictureSelectorPreviewFragmentOnInjectPreviewFragment != null) {
                fragmentNewInstance = pictureSelectorPreviewFragmentOnInjectPreviewFragment;
