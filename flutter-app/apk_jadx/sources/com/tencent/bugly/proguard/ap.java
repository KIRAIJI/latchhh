...
public final class ap {
    ...
    public static String a(long j) {
        try {
            return new SimpleDateFormat(DateUtils.yyyyMMddHHmmss, Locale.US).format(new Date(j));
    ...
    public static String a(Date date) {
        try {
            return new SimpleDateFormat(DateUtils.yyyyMMddHHmmss, Locale.US).format(date);
        } catch (Exception unused) {
            return new Date().toString();
        }
    }
