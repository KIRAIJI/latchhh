...
public final class r {
    ...
    public final void a() {
        ...
        ak.a().a(new b(), (this.b - System.currentTimeMillis()) + CoroutineLiveDataKt.DEFAULT_TIMEOUT);
    }
    ...
    class b implements Runnable {
        ...
        public final void run() {
            ...
            if (jCurrentTimeMillis < r.this.b) {
                ak.a().a(r.this.new b(), (r.this.b - jCurrentTimeMillis) + CoroutineLiveDataKt.DEFAULT_TIMEOUT);
            } else {
                r.this.a(3, false);
                r.this.a();
            }
