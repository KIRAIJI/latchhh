...
public class RoundedDrawable extends Drawable {
    ...
    private void redrawBitmapForSquareCorners(Canvas canvas) {
        ...
        float fWidth = this.mDrawableRect.width() + f;
    ...
    private void redrawBorderForSquareCorners(Canvas canvas) {
        ...
        float f = this.mDrawableRect.left;
        float f2 = this.mDrawableRect.top;
        float fWidth = f + this.mDrawableRect.width();
        float fHeight = f2 + this.mDrawableRect.height();
        float f3 = this.mCornerRadius;
        ...
        if (!this.mCornersRounded[1]) {
            canvas.drawLine((fWidth - f3) - f4, f2, fWidth, f2, this.mBorderPaint);
            canvas.drawLine(fWidth, f2 - f4, fWidth, f2 + f3, this.mBorderPaint);
        }
        if (!this.mCornersRounded[2]) {
            canvas.drawLine((fWidth - f3) - f4, fHeight, fWidth + f4, fHeight, this.mBorderPaint);
            canvas.drawLine(fWidth, fHeight - f3, fWidth, fHeight, this.mBorderPaint);
        }
        if (this.mCornersRounded[3]) {
            return;
        }
        canvas.drawLine(f - f4, fHeight, f + f3, fHeight, this.mBorderPaint);
        canvas.drawLine(f, fHeight - f3, f, fHeight, this.mBorderPaint);
    }
