...
public class BaseBinderAdapter extends BaseQuickAdapter<Object, BaseViewHolder> {
        ...
        if (getMOnItemClickListener() == null) {
            viewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.chad.library.adapter.base.BaseBinderAdapter$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    BaseBinderAdapter.m63bindClick$lambda4(viewHolder, this, view);
                }
            });
        }
        if (getMOnItemLongClickListener() == null) {
            viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.chad.library.adapter.base.BaseBinderAdapter$$ExternalSyntheticLambda2
                ...
                public final boolean onLongClick(View view) {
                    return BaseBinderAdapter.m64bindClick$lambda5(viewHolder, this, view);
                }
            });
        }
    }
    ...
    public static final void m63bindClick$lambda4(BaseViewHolder viewHolder, BaseBinderAdapter this$0, View it) {
        Intrinsics.checkNotNullParameter(viewHolder, "$viewHolder");
    ...
    public static final boolean m64bindClick$lambda5(BaseViewHolder viewHolder, BaseBinderAdapter this$0, View it) {
        Intrinsics.checkNotNullParameter(viewHolder, "$viewHolder");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        int bindingAdapterPosition = viewHolder.getBindingAdapterPosition();
        if (bindingAdapterPosition == -1) {
            ...
            while (it.hasNext()) {
                ...
                if (viewFindViewById != null) {
                    ...
                    viewFindViewById.setOnClickListener(new View.OnClickListener() { // from class: com.chad.library.adapter.base.BaseBinderAdapter$$ExternalSyntheticLambda1
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            BaseBinderAdapter.m62bindChildClick$lambda8$lambda7$lambda6(viewHolder, this, itemBinder, view);
                        }
                    });
                }
            }
            ...
            while (it2.hasNext()) {
                ...
                if (viewFindViewById2 != null) {
                    ...
                    viewFindViewById2.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.chad.library.adapter.base.BaseBinderAdapter$$ExternalSyntheticLambda3
                        @Override // android.view.View.OnLongClickListener
                        public final boolean onLongClick(View view) {
                            return BaseBinderAdapter.m61bindChildClick$lambda11$lambda10$lambda9(viewHolder, this, itemBinder2, view);
                        }
                    });
                }
            }
    ...
    public static final void m62bindChildClick$lambda8$lambda7$lambda6(BaseViewHolder viewHolder, BaseBinderAdapter this$0, BaseItemBinder provider, View v) {
        Intrinsics.checkNotNullParameter(viewHolder, "$viewHolder");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public static final boolean m61bindChildClick$lambda11$lambda10$lambda9(BaseViewHolder viewHolder, BaseBinderAdapter this$0, BaseItemBinder provider, View v) {
        Intrinsics.checkNotNullParameter(viewHolder, "$viewHolder");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(provider, "$provider");
        int bindingAdapterPosition = viewHolder.getBindingAdapterPosition();
