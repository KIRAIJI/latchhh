...
public class BaseLoadMoreModule implements LoadMoreListenerImp {
    ...
    public final void setupViewHolder$com_github_CymChad_brvah(BaseViewHolder viewHolder) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.chad.library.adapter.base.module.BaseLoadMoreModule$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                BaseLoadMoreModule.m87setupViewHolder$lambda1(this.f$0, view);
            }
        });
    }
    ...
    public static final void m87setupViewHolder$lambda1(BaseLoadMoreModule this$0, View view) {
        ...
        if (recyclerViewOrNull != null) {
            recyclerViewOrNull.post(new Runnable() { // from class: com.chad.library.adapter.base.module.BaseLoadMoreModule$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    BaseLoadMoreModule.m86invokeLoadMoreListener$lambda3$lambda2(this.f$0);
                }
            });
            return;
        }
    ...
    public static final void m86invokeLoadMoreListener$lambda3$lambda2(BaseLoadMoreModule this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public final void checkDisableLoadMoreIfNotFullPage() {
        ...
        if (layoutManager instanceof LinearLayoutManager) {
            recyclerViewOrNull.postDelayed(new Runnable() { // from class: com.chad.library.adapter.base.module.BaseLoadMoreModule$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    BaseLoadMoreModule.m84checkDisableLoadMoreIfNotFullPage$lambda4(this.f$0, layoutManager);
                }
            }, 50L);
            ...
            recyclerViewOrNull.postDelayed(new Runnable() { // from class: com.chad.library.adapter.base.module.BaseLoadMoreModule$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    BaseLoadMoreModule.m85checkDisableLoadMoreIfNotFullPage$lambda5(layoutManager, this);
                }
            }, 50L);
        }
    }
    ...
    public static final void m84checkDisableLoadMoreIfNotFullPage$lambda4(BaseLoadMoreModule this$0, RecyclerView.LayoutManager manager) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public static final void m85checkDisableLoadMoreIfNotFullPage$lambda5(RecyclerView.LayoutManager manager, BaseLoadMoreModule this$0) {
        Intrinsics.checkNotNullParameter(manager, "$manager");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
