...
public final class BrvahAsyncDiffer<T> implements DifferImp<T> {
    ...
    public final void submitList(final List<T> newList, final Runnable commitCallback) {
        ...
        this.config.getBackgroundThreadExecutor().execute(new Runnable() { // from class: com.chad.library.adapter.base.diff.BrvahAsyncDiffer$$ExternalSyntheticLambda1
            ...
            public final void run() {
                BrvahAsyncDiffer.m76submitList$lambda1(this.f$0, data, newList, i, commitCallback);
            }
        });
    }
    ...
    public static final void m76submitList$lambda1(final BrvahAsyncDiffer this$0, final List oldList, final List list, final int i, final Runnable runnable) {
        ...
        this$0.mMainThreadExecutor.execute(new Runnable() { // from class: com.chad.library.adapter.base.diff.BrvahAsyncDiffer$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                BrvahAsyncDiffer.m77submitList$lambda1$lambda0(this.f$0, i, list, diffResultCalculateDiff, runnable);
            }
        });
    }
    ...
    public static final void m77submitList$lambda1$lambda0(BrvahAsyncDiffer this$0, int i, List list, DiffUtil.DiffResult result, Runnable runnable) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
