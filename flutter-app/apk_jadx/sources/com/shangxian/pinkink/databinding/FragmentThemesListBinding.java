...
public final class FragmentThemesListBinding implements ViewBinding {
    ...
    private FragmentThemesListBinding(LinearLayout rootView, LinearLayout contentView, PageStateSwitcher pageStateSwitcher, SmartRefreshLayout refreshLayout, RecyclerView rvThemes) {
    ...
    public static FragmentThemesListBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragmentThemesListBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.fragment_themes_list, parent, false);
        if (attachToParent) {
    ...
    public static FragmentThemesListBinding bind(View rootView) {
            ...
            if (pageStateSwitcher != null) {
                ...
                if (smartRefreshLayout != null) {
                    ...
                    if (recyclerView != null) {
                        return new FragmentThemesListBinding((LinearLayout) rootView, linearLayout, pageStateSwitcher, smartRefreshLayout, recyclerView);
                    }
                }
            }
        }
