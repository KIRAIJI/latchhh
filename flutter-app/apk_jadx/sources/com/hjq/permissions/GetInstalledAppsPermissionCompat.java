...
final class GetInstalledAppsPermissionCompat {
    ...
    static Intent getPermissionIntent(Context context) {
        if (PhoneRomUtils.isMiui()) {
            return StartActivityManager.addSubIntentToMainIntent(PhoneRomUtils.isMiuiOptimization() ? PermissionIntentManager.getMiuiPermissionPageIntent(context) : null, PermissionUtils.getApplicationDetailsIntent(context));
        }
