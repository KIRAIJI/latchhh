...
public class WheelTime {
    ...
    public static DateFormat dateFormat = new SimpleDateFormat(DateUtils.yyyyMMddHHmmss);
    ...
    private void setSolar(int i, int i2, int i3, int i4, int i5, int i6) {
        int i7;
        int i8;
        final List listAsList = Arrays.asList("1", ExifInterface.GPS_MEASUREMENT_3D, "5", "7", "8", "10", "12");
