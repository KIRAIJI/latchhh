...
final class X1RefreshAcceptedConnectionLost implements Exception {
  const X1RefreshAcceptedConnectionLost();

  @override
  String toString() =>
      'The refresh command was accepted and the display started refreshing.';
}

final class X1RefreshTriggerConnectionLost implements Exception {
  const X1RefreshTriggerConnectionLost();

  @override
  String toString() =>
      'The NFC connection ended before the refresh command was acknowledged.';
}
